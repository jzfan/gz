    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="list-group">
                ...
                <a href="#" class="list-group-item">{{ str_limit($comment->content, 44) }}  <span class="pull-right">{{ $comment->customer->user->name }}</span></a>
                @endforeach
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="list-group">
                ...
                <a href="#" class="list-group-item">{{ str_limit($article->title, 44) }}  <span class="pull-right">{{ $article->editor->user->name }}</span></a>
                @endforeach
            </div>
